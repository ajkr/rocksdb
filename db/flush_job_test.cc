...
TEST_F(FlushJobTest, Empty) {
  ...
  FlushJob flush_job(dbname_, versions_->GetColumnFamilySet()->GetDefault(),
                     ...
                     &event_logger, false, Env::Priority::USER);
  {
...
TEST_F(FlushJobTest, NonEmpty) {
  ...
  FlushJob flush_job(
      ...
      *cfd->GetLatestMutableCFOptions(), env_options_, versions_.get(), &mutex_,
      ...
      nullptr, nullptr, nullptr, kNoCompression, db_options_.statistics.get(),
      &event_logger, true, Env::Priority::USER);
...
TEST_F(FlushJobTest, Snapshots) {
  ...
  FlushJob flush_job(
      ...
      *cfd->GetLatestMutableCFOptions(), env_options_, versions_.get(), &mutex_,
      ...
      db_options_.statistics.get(), &event_logger, true, Env::Priority::USER);
  mutex_.Lock();
  flush_job.PickMemTable();
  ASSERT_OK(flush_job.Run());
  mutex_.Unlock();
