...
struct CompressionOptions {
  ...
  //
  // A dictionary is created using the first output file from a subcompaction
  // to the bottommost level, and is applied to subsequent output files for the
  // same subcompaction.
  //
  // If zstd_max_train_bytes is nonzero, the dictionary is generated by zstd
  // (see comment above zstd_max_train_bytes). Otherwise, this dictionary will
  // be constructed by random sampling.
  //
  // Default: 0.
  ...
  //
  // This training data is sampled from the first output file in a subcompaction
  // when the target level is bottommost. The training data will be used to
  // generate a dictionary of max_dict_bytes, which will then be applied to
  // subsequent files in the subcompaction.
  //
  // Default: 0.
