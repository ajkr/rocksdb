...
struct TableBuilderOptions {
  TableBuilderOptions(
      ...
      std::string* _compression_dict_samples, bool _skip_filters,
  ...
  // Data sample buffer for generating compression dictionary, or nullptr. It
  // is populated as the table is built according to the CompressionOptions.
